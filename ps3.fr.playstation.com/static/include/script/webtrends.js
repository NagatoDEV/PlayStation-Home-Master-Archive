...
function WebTrends(){
	...
	this.timezone=0;
	this.fpcdom=".playstation.com";
	this.onsitedoms=(function(){return(window.RegExp?new RegExp(".*playstation.com.*","i"):"");})();
